...
var SurchargeArrowWhite = function SurchargeArrowWhite(props) {
  return _react2.default.createElement(
    'svg',
    props,
    _react2.default.createElement('path', {
      fill: '#FFD4E2',
      fillRule: 'nonzero',
      d: 'M3.586 3.996a.602.602 0 0 1 .822 0l2.678 2.55a.535.535 0 0 1 0 .783.602.602 0 0 1-.823 0L4 5.174 1.737 7.329a.615.615 0 0 1-.829 0 .535.535 0 0 1 0-.783zm0-3.102a.602.602 0 0 1 .822 0l2.678 2.55a.535.535 0 0 1 0 .784.602.602 0 0 1-.823 0L4 2.072 1.737 4.228a.615.615 0 0 1-.829 0 .535.535 0 0 1 0-.784z'
    })
  );
};

SurchargeArrowWhite.defaultProps = {
  xmlns: 'http://www.w3.org/2000/svg',
  width: '8',
  height: '8',
  viewBox: '0 0 8 8'
...
var Kaolendar = function (_Component) {
  _inherits(Kaolendar, _Component);

  function Kaolendar(props) {
    _classCallCheck(this, Kaolendar);
    ...
    _this.handleDPClose = function () {
      _this.setState({ isDayPickerOpen: false });
    };

    _this.handleTPClose = function () {
      _this.setState({ isTimePickerOpen: false });
    };

    _this.handleTPBack = function () {
      _this.setState({
    ...
    _this.handleSelectDay = function (selectedObj) {
      var hasTimePicker = _this.props.hasTimePicker;
      _this.setState({
  ...
  _createClass(Kaolendar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        hasTimePicker && isTimePickerOpen && _react2.default.createElement(_TimePicker2.default, {
...
var MiniCal = function MiniCal(props) {
  return _react2.default.createElement(
    'svg',
    props,
    _react2.default.createElement('path', {
      fill: '#99A2A9',
      fillRule: 'evenodd',
      d: 'M8.5 3.5A.5.5 0 0 1 9 4v1.499h6V4a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v1.499l.5.001a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2h-13a2 2 0 0 1-2-2v-11a2 2 0 0 1 2-2l.5-.001V4a.5.5 0 0 1 .5-.5h2zm10 7h-13v7a1 1 0 0 0 .883.993l.117.007h11a1 1 0 0 0 .993-.883l.007-.117v-7z'
    })
  );
};

MiniCal.defaultProps = {
  xmlns: 'http://www.w3.org/2000/svg',
  width: '24',
  height: '24',
  viewBox: '0 0 24 24'
...
var DayPicker = function (_Component) {
  ...
  function DayPicker(props) {
    ...
    _this.handleSetDate = function () {
      var index = _this.state.currentIndex;
      var monthNowArray = _this.props.calendarMonths[index];
      _this.setState({ currentCalMonthArray: monthNowArray });
    };

    _this.handleMonthChange = function (condition) {
      var checkMonthExist = _this.props.calendarMonths[_this.state.currentIndex];
      if (checkMonthExist) {
  ...
  _createClass(DayPicker, [{
    ...
    value: function render() {
      ...
      var calendarLength = calendarMonths.length;
      var weekdayShort = _moment2.default.weekdaysShort();
      var curMonth = calendarMonths && calendarMonths[currentIndex];
      var checkEndOfCal = function checkEndOfCal(index, arrayLength) {
        return arrayLength === index + 1;
      };
      var checkStartOfCal = function checkStartOfCal(index) {
        return index === 0;
      };
      if (!curMonth) {
        return null;
      ...
      return _react2.default.createElement(
        'section',
        { className: 'kld-daypicker__modal' },
        _react2.default.createElement(
          'div',
          { className: 'kld-daypicker' },
          _react2.default.createElement(
            'div',
            { className: 'kld-daypicker__header' },
            _react2.default.createElement(
              'label',
          ...
          _react2.default.createElement(
            'div',
            { className: 'kld-daypicker__month' },
            _react2.default.createElement(
              'button',
              {
            ...
            curMonth && _react2.default.createElement(
              'span',
              { className: 'kld-daypicker__month-name' },
              _constants.monthNames[curMonth.month - 1] + ' ' + curMonth.year
            ),
            _react2.default.createElement(
              'button',
              {
...
var dayNameOfWeek = function dayNameOfWeek(dayName) {
  return _react2.default.createElement(
    'div',
    { className: 'kld-daypicker__dow' },
    dayName.map(function (day, index) {
      return _react2.default.createElement(
        'div',
        { className: 'kld-daypicker__dow-item', key: index },
        day.charAt(0)
      );
    })
  );
...
var dateItem = function dateItem(dates, selectedDate, handleDateSelect) {
  var firstDayOfMonth = new Date(dates[0].value); // Check first day of the month to fill empty
  var emptyDays = Array(firstDayOfMonth.getDay()).fill('');
  var concatDays = emptyDays.concat(dates);
  var colorStyle = function colorStyle(available) {
    return available ? 'kld-daypicker__date-item' : 'kld-daypicker__date-item-unavailable';
  };
  var colorStyleSelected = function colorStyleSelected(dateNow) {
    var selecteISO = new Date(selectedDate);
    return dateNow && (dateNow.getTime() === selecteISO.getTime() ? 'kld-daypicker__date-item-selected' : '');
  };
  ...
  return _react2.default.createElement(
    ...
    concatDays.map(function (d, index) {
      var cd = d ? new Date(d.value) : '';
      return _react2.default.createElement(
        'button',
        {
  ...
  _createClass(TimePicker, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'kld-timepicker' },
          _react2.default.createElement(
            'div',
            { className: 'kld-timepicker__header' },
            _react2.default.createElement(
              'span',
              { className: 'kld-timepicker__header-title' },
              'Select time \u2022 ' + (0, _moment2.default)(selectedDate).format('DD MMM')
            ),
          ...
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(_HourList2.default, {
          ...
          _react2.default.createElement(
            'div',
            { className: 'kld-timepicker__footer' },
            _react2.default.createElement(
              'button',
              { className: 'kld-timepicker__footer-btn-back', onClick: backTP },
              'Back'
            ),
            _react2.default.createElement(
              'button',
...
TimePicker.propTypes = {
  backTP: _propTypes2.default.func,
...
var HourList = function HourList(_ref) {
  ...
  var slots = {
    ...
    var minuteRep = minute === 30 ? 0.5 : 0;
    var timeTotal = hour + minuteRep;
    if (timeTotal <= 12) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'kld-hourlist' },
    Object.keys(slots).map(function (zoneDay, index) {
      return _react2.default.createElement(_HourListItem2.default, {
        key: index,
...
var HourListItem = function HourListItem(_ref) {
  var timeslots = _ref.timeslots,
      label = _ref.label,
      onChangeTime = _ref.onChangeTime,
      selectedTime = _ref.selectedTime;

  var btnStyle = function btnStyle(date) {
    return selectedTime === date ? 'kld-hli__timeslot-item-selected' : 'kld-hli__timeslot-item';
  };
  var surchargeTextStyle = function surchargeTextStyle(date) {
    return selectedTime === date ? 'kld-hli__timeslot-surcharge-selected' : 'kld-hli__timeslot-surcharge';
  };
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'span',
      { className: 'kld-hli__zone' },
      label
    ),
    _react2.default.createElement(
      'div',
      { className: 'kld-hli__timeslot' },
      timeslots.map(function (tsItem, index) {
